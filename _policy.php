...
/*.$num.
		...
		fwrite($sitemap, '<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">');
				...
				$contentLink = "<sitemap>";
					$contentLink .= "<loc>";
						$contentLink .= G5_URL."/data/site/".$bo_table.$domain."sitemap".$num.".xml";
					$contentLink .= "</loc>";
				$contentLink .= "</sitemap>";
